    ...
    @if ($subs->quota == $ads->count())
        <div class="col-12">
            <div class="alert alert-warning alert-dismissible fade show">
                <p class="text-center mb-0"><i class="fas fa-exclamation"></i> Quota is empty. Please add more if you want to post more advertisement. Click <a href="{{ route('advertiser.profile')}}" style="color: #007bff;">here.</a></p>
            </div>
