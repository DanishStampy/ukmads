...
<div class="container-fluid">
    ...
    <div class="container">
        <form action="{{ route('advertiser.uploadAds') }}" method="POST" class="form-horizontal" enctype="multipart/form-data">
            @csrf
            <div class="row">
                <div class="col-md-6">
                    <div class="card">
                    ...
                    <div class="card">
                        ...
                        <br> --}}
                            ...
                            <div class="row">
                                ...
                                <div class="col">
                                    <div class="form_group">
                                        <input id="price" type="number" min="0.00" step="0.01" class="form_input" name="price" placeholder=" "
                                            value="">
                            ...
                            <div class="row">
                                ...
                                <div class="col">
                                    <div class="form_group">
                                        ...
                                        placeholder="#601234567890" pattern="^601[0-9]{1}([0-9]{8}|[0-9]{7})"value="">
