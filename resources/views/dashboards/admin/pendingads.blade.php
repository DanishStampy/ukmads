                                    ...
                                    <div class="text-center">
                                        <form method="post" class="form-horizontal"
                                            ...
                                            <button name="type" value="approved" type="submit"
                                                class="btn btn-success btn-block" id="btnAdsApproved">
                                                Approve
                                            </button>
                                            <button name="type" value="rejected" type="submit"
                                                class="btn btn-danger btn-block" id="btnAdsRejected">
                                                Reject
                                            </button>
                                        </form>
                                    </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="text-center">
                                        <form method="post" class="form-horizontal"
                                            ...
                                            <button name="type" value="approved" type="submit"
                                                class="btn btn-success btn-block" id="btnEventApproved">
                                                Approve
                                            </button>
                                            <button name="type" value="rejected" type="submit"
                                                class="btn btn-danger btn-block" id="btnEventRejected">
                                                Reject
                                            </button>
                                        </form>
                                    </div>
